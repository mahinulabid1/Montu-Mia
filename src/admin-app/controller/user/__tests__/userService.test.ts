...
import type { User } from "@/admin-app/controller/user/userModel";
import { UserRepository } from "@/admin-app/controller/user/userRepository";
import { UserService } from "@/admin-app/controller/user/userService";

vi.mock("@/admin-app/controller/user/userRepository");
